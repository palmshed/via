...
class SettingsDialog extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final lastNonAdjustTheme = useRef<AppThemeMode>(
        currentTheme == AppThemeMode.adjust
            ? AppThemeMode.system
      ...
      try {
        ...
        if (context.mounted) {
          ScaffoldMessenger.of(context).showSnackBar(
            const SnackBar(
                content: Text(
                    'Firebase config saved — restart required for changes')),
          );
        }
      } catch (e) {
                ...
                children: [
                  ...
                  TextField(
                    ...
                    onSubmitted: (value) async {
                      ...
                      if (UrlUtils.isValidUrl(resolved)) {
                        ...
                        homepageController.text =
                            homepage.value == defaultHomepageUrl
                                ? ''
                                : homepage.value ?? '';
                        if (context.mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                                content: Text('Invalid homepage URL')),
                          );
                        }
                      }
                    },
                  ...
                  MouseRegion(
                    ...
                    child: RadioListTile<AppThemeMode>(
                      ...
                      groupValue: selectedTheme.value == AppThemeMode.adjust
                          ? lastNonAdjustTheme.value
                          : selectedTheme.value,
                      dense: true,
                  ...
                  MouseRegion(
                    ...
                    child: SwitchListTile(
                      ...
                      onChanged: (value) {
                        ...
                        saveSetting(
                            urlAutocompleteSuggestionRemovalEnabledKey, value);
                      },
                      hoverColor: Colors.transparent,
                    ),
                  ),
                  ...
                  ListTile(
                    ...
                    trailing: effectiveUpdateInfo != null
                        ? (downloadProgress.value != null
                            ...
                            : OutlinedButton(
                                onPressed: () =>
                                    handleUpdate(effectiveUpdateInfo),
                  ...
                  if (onClearAllData != null) ...[
                    ...
                    MouseRegion(
                      ...
                      child: ListTile(
                        ...
                        subtitle: const Text(
                            'Erase settings, passwords, caches, and profiles'),
                        onTap: () async {
                          final confirm = await showDialog<bool?>(
                            context: context,
